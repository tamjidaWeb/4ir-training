...
document.getElementById('load_more_content').addEventListener('click', function () {
    document.getElementById('load_more_content').style.display = 'none';
    document.getElementById('load_for_mobile_device').style.display = 'block';
});
...
function toggleFields() {
    ...
    const isEmployed = document.querySelector('input[name="employment"]:checked').value;
