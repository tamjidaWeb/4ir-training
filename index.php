        ...
        <div class="row">
            <div class="col-12">
                <div class="banner-container mb-5">
                    <div class="banner">
                        <img
                            src="image/Web Cover.PNG"
                            alt="Vendor Certification Training Banner" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="text-content">
                    <p id="pid">
                        ...
                        <span>Digital Entrepreneurship and Innovation
                            Eco-System Development Project (DEIEDP)</span>
                        , is thrilled to announce a transformative training
                        program on
                        <span>4IR (Fourth Industrial
                            Revolution)Technologies.</span>
                ...
                <div class="form">
                    ...
                    <form
                        ...
                        <div class="input-type-block mb-3">
                            ...
                            <div class="mb-3">
                                <label for="degree" class="input-label">
                                    <span>*</span>
                                    Degree
                                </label>
                                <input
                            ...
                            <div class="input-type-block mb-3">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <label
                                            for="freshGraduate"
                                            class="form-check-label">Fresh Graduate</label>
                                    </div>
                                    <div class="form-check">
                                        <input
                                            type="radio"
                                            ...
                                            required />
                                        <label
                                            for="unemployedGraduate"
                                            class="form-check-label">Unemployed Graduate</label>
                                    </div>
                                    <div class="form-check">
                                        <input
                                            type="radio"
                                            ...
                                            required />
                                        <label
                                            for="employedGraduate"
                                            class="form-check-label">Employed Graduate</label>
                                    </div>
                                    <div class="form-check">
                                        <input
                                            type="radio"
                                        ...
                                        <label
                                            for="freelancer"
                                            class="form-check-label">Freelancer</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            class="form-group check-gender mb-3"
                            id="myForm">
                        ...
                        <div class="hidden" id="employmentFields">
                            ...
                            <div class="mb-3">
                                <label
                                    class="input-label"
                                    for="jobDesignation">Current Job Designation /
                        ...
                        <select
                            ...
                            <option value="Phase 1">
                                Phase 1 (7th Dec'24 – 16th Mar'25)
                            </option>
                            <option value="Phase 2">
                                Phase 2 (12th April'25 – 20th Jul'25)
                            </option>
                            <option value="Phase 3">
                                Phase 3 (1st Aug'25 – 2 nd Nov'25)
                            </option>
                        </select>
                        ...
                        <select
                            ...
                            class="form-select mb-3"
                            aria-label="Default select example">
                            <option selected disabled value="" id="text2">
                                Courses
                            </option>
                        </select>
                        ...
                        <div class="input-type-block mb-3">
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label
                                        class="custom-file-label"
                                        for="validatedCustomFile3"><span class="file-return"></span></label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <ul class="vertical-list mb-4">
                                <li class="li-li">
                                    <a
                                        href="https://www.facebook.com/wiztecbd"
                                        target="_blank">
                                        <!-- Facebook -->
                                        <svg
                                ...
                                <li class="li-li">
                                    <a
                                        href="https://wa.me/+8801600299169"
                                        target="_blank">
                                        <!-- What's app -->
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li class="li-li">
                                    <a
                                        href="https://www.linkedin.com/company/wiztecbd/mycompany/"
                                        target="_blank">
                                        <!-- Linkedin -->
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li class="li-li">
                                    <a
                                        href="https://www.instagram.com/wiztecbd_/?igsh=MXVtZHViaWNucnljMw%3D%3D#"
                                        target="_blank">
                                        <!-- Instagram -->
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
